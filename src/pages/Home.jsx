...
const Home = () => {
    ...
    return (
        <div id='home'>
            ...
            <div className="relative h-screen bg-[url('/back.jpg')] bg-cover bg-no-repeat">
                <div className="absolute inset-0 bg-black bg-opacity-50"></div> 
                {/* Overlay */}
                <Navbar />
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
                    <h1 className="text-3xl md:text-6xl font-serif font-bold mb-4 animate-slide-in">
                        Welcome to Rising Star
                    </h1>
                    <p className="text-lg font-serif md:text-2xl mb-6 animate-slide-in">
